...
exports.handle = function (msg, cb) {
    //var parameter = req.body._json
    var parameter = msg._json
    ...
    switch (type) {
        case 'door':
            ...
            getUserByMac(parameter.deviceId, function (err, doc) {
                ...
                message.localCreate(doc, content, null, function (err, doc) {
                    if(err){
                        return cb(err,null);
                    }
                    if (doc == null) {
        ...
        case 'temperature':
            if (value > config.jpush.temperature) {
                getUserByDeviceId(parameter.deviceId, function (err, doc) {
                    ...
                    message.localCreate(doc, config.jpush.temperatureContent, null, function (err, doc) {
                        if(err){
                            return cb(err,null);
                        }
                        if (doc == null) {
        ...
        case 'humidity':
            if (value > config.jpush.humidity) {
                getUserByDeviceId(parameter.deviceId, function (err, doc) {
                    ...
                    message.localCreate(doc, config.jpush.humidityContent, null, function (err, doc) {
                        if(err){
                            return cb(err,null)
                        }
                        if (doc == null) {
        ...
        case 'gasdetection':
            if (value > config.jpush.gasdetection) {
                getUserByDeviceId(parameter.deviceId, function (err, doc) {
                    ...
                    message.localCreate(doc, config.jpush.gasdetectionContent, null, function (err, doc) {
                        if(err){
                            return cb(err, null);
                        }
                        if (doc == null) {
